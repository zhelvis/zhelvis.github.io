...
то нам придётся запрашивать и кешировать их на стороне клиента после загрузки страницы. Это не является отпимальным решением.
...
модулей, специфичных для браузера (импортирование css и полифилов, настройка стратегии кеширования)
